    ...
    <Col className="container-type d-flex align-items-center justify-content-center gap-3">
      <Form.Group className="col-lg-6">
        <Form.Check type="radio" className="radio-group">
          <Form.Check.Input id="costumer" type="radio" name="type" value="false" onChange={(e) => setField("isFreelancer", JSON.parse(e.target.value))} required />
      ...
      <Form.Group className="col-lg-6">
        <Form.Check type="radio" className="radio-group">
          <Form.Check.Input id="freelancer" type="radio" name="type" value="true" onChange={(e) => setField("isFreelancer", JSON.parse(e.target.value))} required />
